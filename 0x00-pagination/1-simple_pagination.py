#!/usr/bin/env python3
"""
Defining class Server that paginates a databases of popular baby names
"""
import csv
import math
...
def index_range(page: int, page_size: int) -> Tuple[int, int]:
    ...
    Args:
        page (int): Is the page number to return (pages are 1-indexed)
        page_size (int): Is the number of items per page
    Return:
